...
// The CpuFunc type is an adapter to allow the use of ordinary
// function as Cpu mutator.
type CpuFunc func(context.Context, *ent.CPUMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CpuFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.CPUMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CPUMutation", m)
	}
	return f(ctx, mv)
}
...
// The NetstatFunc type is an adapter to allow the use of ordinary
// function as Netstat mutator.
type NetstatFunc func(context.Context, *ent.NetstatMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f NetstatFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.NetstatMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.NetstatMutation", m)
	}
	return f(ctx, mv)
}
