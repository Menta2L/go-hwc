...
type Data struct {
	...
	Server   *Data_Server   `protobuf:"bytes,3,opt,name=server,proto3" json:"server,omitempty"`
}
...
func (x *Data) GetServer() *Data_Server {
	if x != nil {
		return x.Server
	}
	return nil
...
func (x *Data_Server) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Server) ProtoMessage() {}

func (x *Data_Server) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Server.ProtoReflect.Descriptor instead.
func (*Data_Server) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_Server) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x64, 0x69, 0x73, 0x12, 0x2f, 0x0a, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x06,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x1a, 0x3a, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x1c, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x32, 0x6c, 0x2f, 0x67, 0x6f, 0x2d,
	0x68, 0x77, 0x63, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6e,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Server)(nil),       // 7: kratos.api.Data.Server
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.server:type_name -> kratos.api.Data.Server
